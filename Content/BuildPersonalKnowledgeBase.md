...
> [!NOTE]
>
> 欢迎来到我的知识库网站，本站与2023年4月1日建站开始，这文章也是知识库的第一篇文章。这个网站在一点点地丰富，也因为你的到来，让这个网站开始变得更有价值。因为我想相信**志同道合的人本就应该成群结队**。
>
> 在这里，我将再一次声明**建站的初衷**：
>
...
> [!NOTE]
> 1> 找到你在本地生成编写文档的目录进去，然后CMD。
>
> 2> 在通过运行 docsify serve 启动一个本地服务器，可以方便地实时预览效果。
>
